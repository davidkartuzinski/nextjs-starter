...
summary: See how well Markdown is supported use MDX and Next.js.  Compared to the Markdown Cheatsheet.
featured: true
categories:
  - markdown
  - mdx
...
This cheatsheet shows you the markdown that is supported when using Mdx with Next.js.

<img
  src='/user-content/images/posts/markdown-cheatsheet/markdown.svg'
  alt='This is the Markdown Logo'
  width={300}
  height={300}
  priority='true'
/>
...
Using PrismJS with Next.js affords you the ability to share and highlght code snippets.
